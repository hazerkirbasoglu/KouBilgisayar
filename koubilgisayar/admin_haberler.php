			...
			<div class="row">
				...
				<div class="col-md-9">
					<div class="profile-body margin-bottom-20">
						...
						<a class="btn-u margin-bottom-20" href="admin_haberekle.php">Yeni Haber Ekle</a>
							...
							<div class="table-responsive">
								<table class="table table-hover table-bordered table-striped">
									...
									<?php
										...
										$sql = 'SELECT d.*,a.Unvan FROM Haberler d inner join adminler a on a.ID = d.AdminID';
										$result = $conn->query($sql);
										if ($result->num_rows > 0) {
											while($row = $result->fetch_assoc()) {
							
												$htmlString = '<tr><td>'.$row["HaberBaslik"].'</td><td>'.$row["HaberIcerikHtml"].'</td><td>'.$row["Tarih"].'</td><td>'.$row["Unvan"].'</td><td><a class="btn-u btn-u-blue" href="admin_haberguncelle.php?id='.$row["ID"].'">Guncelle</a></br></br><a class="btn-u btn-u-red" href="_habersil.php?id='.$row["ID"].'">Sil</a></td></tr>';
