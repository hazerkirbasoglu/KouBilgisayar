			...
			<div class="row">
				...
				<div class="col-md-9">
					<div class="profile-body margin-bottom-20">
						...
						<form action="_haberekle.php" method="post">
							<div class="headline"><h3>Haber Ekle</h3></div>
							<div class="margin-bottom-20"></div>
							<h4>Haber Başlığı</h4>
							<input type="text" name="HaberBaslik" class="form-control"/>
							<h4>Haber İçeriği</h4>
							<textarea class="form-control" rows="7" name="HaberIcerik"></textarea>
							<!--End Textarea-->
