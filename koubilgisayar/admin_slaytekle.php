			...
			<div class="row">
				...
				<div class="col-md-9">
					<div class="profile-body margin-bottom-20">
						...
						<form action="_slaytekle.php" method="post" enctype="multipart/form-data">
							<div class="headline"><h3>Slayt Ekle</h3></div>
							<div class="margin-bottom-20"></div>
							<h4>Slayt Başlığı</h4>
							<textarea class="form-control" rows="7" name="SlaytBaslik"></textarea>
							<!--End Textarea-->
